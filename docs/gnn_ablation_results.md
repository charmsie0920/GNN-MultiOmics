...
**Scripts:** [`experiments/GNN Ablation/gnn_baseline.py`](../experiments/GNN%20Ablation/gnn_baseline.py), [`src/models/hetero_gnn.py`](../src/models/hetero_gnn.py), [`src/data/04_link_cell_lines.py`](../src/data/04_link_cell_lines.py)
**Raw results:** `experiments/GNN Ablation/gnn_results.csv`
**Companions:** [`rf_ablation_results.md`](./rf_ablation_results.md), [`mlp_ablation_results.md`](./mlp_ablation_results.md), [`cross_attention_ablation_results.md`](./cross_attention_ablation_results.md), [`results.md`](./results.md)
