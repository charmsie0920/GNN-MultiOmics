...
**Scripts:** [`experiments/08_ensemble_refinement/ensemble_baseline.py`](../experiments/08_ensemble_refinement/ensemble_baseline.py), [`src/models/ensemble_refinement.py`](../src/models/ensemble_refinement.py)
**Raw results:** `experiments/08_ensemble_refinement/ensemble_results.csv`
**Companions:** [`06_cross_attention_ablation_results.md`](./06_cross_attention_ablation_results.md), [`07_gnn_ablation_results.md`](./07_gnn_ablation_results.md), [`results.md`](./results.md)
...
2. **Treat cross-dataset comparisons with the paper cautiously.** Their headline
   ...
   [`09_split_protocol_comparison.md`](./09_split_protocol_comparison.md): protocol
...
3. **The confirmatory experiment was run, and the hypothesis held.** Re-running
   ...
   [`09_split_protocol_comparison.md`](./09_split_protocol_comparison.md).
...
- **The GNN base number differs slightly from its matrix run** (1.3305 here vs
  1.3513 in [`07_gnn_ablation_results.md`](./07_gnn_ablation_results.md)). Both are
