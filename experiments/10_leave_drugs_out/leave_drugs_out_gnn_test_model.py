...
Run from the repository root:
    python "experiments/10_leave_drugs_out/leave_drugs_out_gnn_test_model.py"
"""
...
ldo_gnn = load_module("ldo_gnn", "experiments/10_leave_drugs_out/leave_drugs_out_gnn.py")
