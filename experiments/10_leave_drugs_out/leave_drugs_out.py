...
choice in the final architecture -- see docs/06_cross_attention_ablation_results.md
...
Run from the repository root:
    python "experiments/10_leave_drugs_out/leave_drugs_out.py"
"""
...
RESULTS_CSV = Path("experiments/10_leave_drugs_out/leave_drugs_out_results.csv")
