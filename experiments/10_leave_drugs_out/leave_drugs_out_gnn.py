...
docs/10_leave_drugs_out_results.md). No GNN has ever been run through that split:
every GNN number in the project (docs/07_gnn_ablation_results.md, E12/E24/E56/E58
...
04_link_cell_lines.py:
    python "experiments/10_leave_drugs_out/leave_drugs_out_gnn.py"
"""
...
RESULTS_CSV = Path("experiments/10_leave_drugs_out/leave_drugs_out_gnn_results.csv")
...
def main() -> None:
    ...
    print("\n--- context: fingerprint arms from leave_drugs_out.py (docs/10_leave_drugs_out_results.md) ---")
