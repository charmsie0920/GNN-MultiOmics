...
Run from the repository root:
    python "experiments/Ensemble Refinement/ensemble_baseline.py"
"""
...
RESULTS_CSV = Path("experiments/Ensemble Refinement/ensemble_results.csv")
...
gnn_mod = load_module("gnn_base", "experiments/GNN Ablation/gnn_baseline.py")
