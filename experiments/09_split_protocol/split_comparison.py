...
It also tests the leakage hypothesis from docs/08_ensemble_refinement_results.md:
...
Run from the repository root:
    python "experiments/09_split_protocol/split_comparison.py"
"""
...
RESULTS_CSV = Path("experiments/09_split_protocol/split_comparison_results.csv")
...
ens_mod = load_module("ens_base", "experiments/08_ensemble_refinement/ensemble_baseline.py")
