...
Run from the repository root:
    python "experiments/01_cross_attention_fusion/cross_attention_baseline.py"
"""
...
# Repo root (three levels up from this file: .../<repo>/experiments/01_cross_attention_fusion/this.py)
